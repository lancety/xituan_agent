...
| `image-normalize-full-backfill` | `planned` | S3 **全部**老图预生成（**本机批处理**，不走 Lambda） | C3 测稳后再跑 | 本机脚本扫库+扫桶；幂等；限速 | [entry](./entries/2026-09-image-normalize-full-backfill.md) | 2026-09-06 |
